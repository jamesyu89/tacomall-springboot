package cn.tacomall.tacomallspringbootapiopen.controller;
...
import cn.tacomall.tacomallspringbootcommon.utils.JsonUtil;
import cn.tacomall.tacomallspringbootapiopen.config.WxMaConfig;
...
public class WxMa {
    ...
    @GetMapping(name = "/portal/", produces = "text/plain;charset=utf-8")
    ...
    @PostMapping(name = "/portal/", produces = "application/xml; charset=UTF-8")
